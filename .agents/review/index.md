...
| csv-kill-d1 | MEDIUM  | Over-removal: killing CSV enrichment strips the surviving query/download path or breaks the warnings-as-errors build | `[~]`  | —      | (pending dispatch) |
