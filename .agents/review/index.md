...
| slice-b2 | MEDIUM  | Broken render branch or misapplied theme → wrong/unreadable headline answer | `[~]`  | —      | codex/@azure-openai-eus2-global/gpt-5.5-dzs/xhigh/standard (`--profile review`) — **reopened** R1 (incomplete theme migration); repaired `08cb19b`; T5 redispatch pending owner ruling on frontier tier |
